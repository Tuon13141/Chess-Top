...
var ASM_CONSTS = {
  6098368: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 6098429: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 6098493: function() {return Module.webglContextAttributes.powerPreference;},  
 6098551: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 6098606: function($0) {performance.now = function() { return $0; };},  
 6098654: function($0) {performance.now = function() { return $0; };},  
 6098702: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _ShareScreenshot(array, size, fileNamePtr) {
      ...
      if (navigator.share) {
        navigator.share({
          ...
          text: 'Welcome to Athene Chess - The Ultimate Battle of Wits! Challenge every chess master and prove your talent!',
          files: [file],
        }).then(() => {
  ...
  function _WS_Create(url, protocol, onOpen, onText, onBinary, onError, onClose) {
          ...
          socket.socketImpl.onerror = function(e) {
              ...
              // Do not call this, onClose will be called with an appropriate error code and reason
...
var asmLibraryArg = {
  ...
  "ShareScreenshot": _ShareScreenshot,
...
/** @type {function(...*):?} */
var dynCall_iiififiiiiiii = Module["dynCall_iiififiiiiiii"] = createExportWrapper("dynCall_iiififiiiiiii");
